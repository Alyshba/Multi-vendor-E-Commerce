            ...
            <div class="card-body">
                ...
                <div class="p-3 bg-light rounded-3 mb-4 text-start">
                    <div class="row g-2">
                        ...
                        <div class="col-8 fw-semibold">{{ is_string($product->category) ? $product->category : ($product->category->name ?? 'N/A') }}</div>
                ...
                <form method="POST" action="{{ route('vendor.products.destroy_confirm', $product->id) }}">
                    @csrf
